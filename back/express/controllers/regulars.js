...
module.exports.getAll = async (req, res) => {
    const { userId } = req
    try {
        const expenses = await db.query(db.regulars.getAll, [userId])
...
module.exports.getOne = async (req, res) => {
    ...
    const { userId } = req
    try {
        const expense = await db.query(db.regulars.getOne, [userId, id])
...
module.exports.editOne = async (req, res) => {
    ...
    const { userId } = req
    try {
        const expenseRes = await db.query(db.regulars.getOne, [userId, id])
